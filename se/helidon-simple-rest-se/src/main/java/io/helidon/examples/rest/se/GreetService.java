...
package io.helidon.examples.rest.se;
...
public class GreetService implements Service {
    ...
    HealthCheckResponse checkAlive() {
        HealthCheckResponseBuilder builder = HealthCheckResponse.builder().name("greetingAlive");
     ...
     */
    private void counterFilter(final ServerRequest request, final ServerResponse response) {
        displayThread();
        greetCounter.inc();
        request.next();
    }
